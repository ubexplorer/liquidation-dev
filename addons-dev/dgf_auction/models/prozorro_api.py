...
class ProzorroApi(models.AbstractModel):
    ...
    def _search_by(self, base_url=None, search_parameter=None, search_value=None, params=None, description=None):
        ...
        if all([base_url, search_parameter, search_value, params]):  # if search_parameter is not None and search_value is not None:
            responce = self._contact_api(base_url=base_url, api_method=search_by, params=params, description=description)
            return responce
        else:
    ...
    def _byAuctionId(self, base_url=None, auction_id=None, description=None):
        ...
        if auction_id is not None:
            responce = self._search_by(base_url=base_url, search_parameter=search_by, search_value=auction_id, description=description)
            return responce
        else:
    ...
    def _byDateModified(self, base_url=None, date_modified=None, params=None, description=None):
        ...
        if all([base_url, date_modified, params]):  # if date_modified is not None:
            responce = self._search_by(base_url=base_url, search_parameter=search_by, search_value=date_modified, params=params, description=description)
            return responce
        else:
            raise exceptions.UserError(
    ...
    def _byAuctionOrganizer(self, base_url=None, organizer_id=None, params=None, description=None):
        ...
        if all([base_url, organizer_id, params]):  # if organizer_id is not None:
            responce = self._search_by(base_url=base_url, search_parameter=search_by, search_value=organizer_id, params=params, description=description)
            return responce
        else:
            raise exceptions.UserError(
    ...
    def _update_auction_detail(self, base_url=None, _id=None, description=None):
        if _id is not None:
            ...
            responce = self._contact_api(base_url=base_url, api_method=api_method, description=description)
            return responce
        else:
            raise exceptions.UserError(
