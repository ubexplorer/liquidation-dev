...
class TestRequestEvents(ReduceLoggingMixin, SavepointCase):

    @classmethod
    def setUpClass(cls):
        super(TestRequestEvents, cls).setUpClass()
        cls.event_category_request_event = cls.env.ref(
            'dgf_request_base.system_event_category_request_events')
        cls.event_category = cls.env.ref(
            'dgf_request_base.system_event_category_request_sub_request_events')
        ...
        cls.subrequest1_stage1 = cls.env.ref(
            'dgf_request_base.request_stage_type_access_new')
        cls.subrequest1_stage12 = cls.env.ref(
            'dgf_request_base.request_stage_type_access_sent')
        cls.subrequest1_stage2 = cls.env.ref(
            'dgf_request_base.request_stage_type_access_granted')
