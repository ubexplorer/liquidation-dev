...
class TestRequestChannelRPC(common.HttpCase):
    ...
    def setUp(self):
        ...
        self.simple_type = self.env.ref('dgf_request_base.request_type_simple')

        self.channel_api = self.env.ref('dgf_request_base.request_channel_api')
        self.channel_call = self.env.ref(
            'dgf_request_base.request_channel_call')
