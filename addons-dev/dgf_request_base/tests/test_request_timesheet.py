...
class TestWizardLogTime(RequestCase):
    ...
    def setUpClass(cls):
        ...
        cls.activity_id_1 = cls.env.ref(
            'dgf_request_base.request_timesheet_activity_coding')
        cls.activity_id_2 = cls.env.ref(
            'dgf_request_base.request_timesheet_activity_analysis')
        cls.user = cls.env.ref('dgf_request_base.user_demo_request')
