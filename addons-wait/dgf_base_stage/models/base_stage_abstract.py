...
class BaseStageAbstract(models.AbstractModel):
    """Inherit from this class to add support for stages to your model.
    ...
    _name = "base.stage.abstract"
    _description = "Stage Abstract"
    ...
    def _default_stage_id(self):
        return self.env["base.stage"].search(
    ...
    stage_id = fields.Many2one(
        string="Stage",
        comodel_name="base.stage",
        tracking=True,
        index=True,
        copy=False,
        help="The stage that this record is currently in",
    ...
    def _valid_field_parameter(self, field, name):
        # allow tracking on models inheriting from 'base.stage'
